...
import { useDemoStore } from "@core/hooks/useDemoStore";
import { DemoContextType } from "@core/contexts/demoContext";
...
describe("Layout component", () => {
  ...
  beforeEach(async () => {
    const storeMod = await import("@core/hooks/useDemoStore");
